	...
	with (ss) {
		...
		if (v && document.getElementById(s[v - 1]).selectedIndex > 0 || !v) {
			if (dsy.Exists(str)) {
				...
				{
					var len = ar[i].indexOf("-");
					if(len!=-1)
					{
						//alert(ar[i].substring( 0, len));
						//alert(ar[i].substring( len+1 , ar[i].length ));
						options[length] = new Option(ar[i].substring( 0, len), ar[i].substring( len+1 , ar[i].length ));
					}else
					{
...
dsy.add("0", [ "北京-BJ", "安徽-AH", "福建-FJ", "甘肃-GS", "广东-GD", "广西-GX", "贵州-GZ", "海南-HI", "河北-HE", "河南-HA",
		"黑龙江-HL", "湖北-HB", "湖南-HN", "吉林-JL", "江苏-JS", "江西-JX", "辽宁-LN", "内蒙古-NM", "宁夏-NX", "青海-QH", "山东-SD",
		"山西-SX", "陕西-SN", "上海-SH", "四川-SC", "天津-TJ", "西藏-XZ", "新疆-XJ", "云南-YN", "浙江-ZJ", "重庆-CQ", "澳门-MO", "香港-HK", "台湾-TW" ]);
...
dsy.add("0_4", [ "广州", "潮州", "东莞", "佛山", "河源", "惠州", "江门", "揭阳", "茂名", "梅州",
		"清远", "汕头", "汕尾", "韶关", "深圳", "阳江", "云浮", "湛江", "肇庆", "中山", "珠海" ]);

dsy.add("0_5", [ "南宁", "百色", "北海", "崇左", "防城港", "桂林", "贵港", "河池", "贺州", "来宾",
		"柳州", "钦州", "梧州", "玉林" ]);

dsy.add("0_6", [ "贵阳-GY", "安顺", "毕节", "六盘水", "黔东南苗族侗族自治州", "黔南布依族苗族自治州",
		"黔西南布依族苗族自治州", "铜仁", "遵义" ]);
