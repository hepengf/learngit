...
<%@page language="java" import="java.util.*,com.congoal.cert.pojo.*"%>
...
<link id="css_main" rel="stylesheet" type="text/css" href="${basePath}/theme/dandelion2/main.css" />
...
function setIFrameHeight() {
	$("#pageResult").height(650);
	var mainheight = $("#pageResult").contents().find("body").attr('scrollHeight');
	if (mainheight < 650) {
		mainheight = 650;
	}
	$("#pageResult").height(mainheight);
}
</script>	
...
<table width="100%" border="0" cellspacing="0" cellpadding="0"  id="index_content">
  <tr>
	...
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
      	<tr>
        	<td width="100%" >
        	<span style="font-family:'Times New Roman';color: white;font-weight: bold;width: 20%; padding-left: 10px">
        	空中充值CA认证系统 
        	</span>
        	</td>
        </tr>
		...
		<table width="100%"  border="0" cellspacing="0" cellpadding="0">
		  <tr>
			...
			　　<span class="telStyle" style="font-family:'Times New Roman'">支持热线(020-81000000)</span>　
				<a class="helpStyle" style="text-decoration: none;font-family:'Times New Roman'" href="Help.jsp" target="pageResult">使用帮助</a>
				<!-- <span class="helpStyle" style="font-family:'Times New Roman'" onclick="help()">使用帮助</span>　 -->
<!-- 				<span class="telStyle" style="font-family:'Times New Roman'">联系我们</span></td> -->
				...
				<a href="#" style="text-decoration: none;color:#ffffff;" onclick="logout('<%=request.getContextPath() %>/j_spring_security_logout');return false;">&nbsp;退出&nbsp; </a></span> --%>
				<span style="float: right;">&nbsp;&nbsp;<img src="web/img/index_nav4.gif" width="12" height="14" align="absmiddle" style="padding-bottom: 2px;"> 
				<a href="#" style="text-decoration: none;color:#ffffff;" onclick="logout('<%=request.getContextPath() %>/j_spring_security_logout');return false;">&nbsp;退出&nbsp; </a>&nbsp;&nbsp;&nbsp;</span>
			</td>
		  </tr>
		</table>
      ...
      <tr>
      	<td>
      	    <iframe name="pageResult" 
						...
						height="0px"
						scrolling="no"
						onload="setIFrameHeight();" src="blank.jsp" style="background-color: ffffff">
			</iframe>
      	</td>
      </tr>
