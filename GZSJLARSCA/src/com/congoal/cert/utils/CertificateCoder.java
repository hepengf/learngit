...
public abstract class CertificateCoder  {
    ...
    private static final Logger logger = LoggerFactory.getLogger(CertificateCoder.class);
	...
	public static Certificate generateCertificate(byte[] encoded) throws CertificateException {
